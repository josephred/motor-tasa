              ...
              <div class="panel panel-default">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-6  ">
                                <div class="main-box infographic-box colored yellow-bg graficos_click" id="estadisticas"
                                     style="height: 160px;">
                                    <i class="fa fa-desktop "></i>
                                    <span class="headline">Canal WEB &nbsp; &nbsp; &nbsp; &nbsp; </span>
                            ...
                            <div class="col-lg-6 col-sm-5 ">
                                <div class="main-box infographic-box colored purple-bg graficos_click" id="estadisticas"
                                     style="height: 160px;">
