                                        ...
                                        <div class="table-responsive">
                                            <table id="table-example-fixed" class="table table-hover">
                                                ...
                                                <tr class="">
                                                    ...
                                                    <td>
                                                        <button class="btn btn-light" style='margin-left: 16px; '
                                                                type="button" data-toggle="modal"
                                                                data-target="#ModalAdminVar"><i class="fa fa-eye"
                                                                                                aria-hidden="true"></i>
                                                        </button>
                                                    </td>
                                                </tr>
                                                ...
                                                <div class="main-box-body clearfix">
                                                    <div class="table-responsive">
                                                        <table class="table table-hover" id="table-example-fixed2" >
                                                            <thead>
                                                            <tr>
                                                                <td colspan="9"><h2>Solicitudes revisadas</h2></td>
                                                            </tr>
                                                            <tr>
                                                                <td class="pull-right">
                                                            ...
                                                            <tr class="">
                                                                ...
                                                                <td>
                                                                    <button class="btn btn-light"
                                                                            style='margin-left: 16px; ' type="button"
                                                                            data-toggle="modal"><i class="fa fa-refresh" aria-hidden="true"></i></button>
                                                                </td>
                                                                <td>No cumple con las normas básicas </td>
                    ...
                    <div class="modal-content">
                      ...
                      Vigencia: 2021-08-01,2021-08-15
                        ...
                        <div class="modal-footer">
                            <button class="btn btn-primary btn-sm col-md-3"> Guardar</button>
