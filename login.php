  ...
  <body id="login-page-full">
                    ...
                    <div id="login-box-inner">
                      <form role="form" action="login.php" name="frm" id="frm" method="post">
                        <div class="input-group">
                          ...
                          <input class="form-control" type="text" name="Email" id="Email" placeholder="Usuario" required>
                        </div>
                        <div class="input-group">
                          <span class="input-group-addon"><i class="fa fa-user"></i></span>
                          <input class="form-control" type="text" name="Rut" id="Rut" placeholder="RUT Empresa" required>
                        </div>
                        <div class="input-group">
    ...
    <script>  
      ...
      $('body').on('click', '#btn_login', function(){
        ...
        $.ajax({ url: "controlador.php", type: "POST", dataType: "json",
            data: {
              usuario: $('#Email').val(),
              rut: $('#Rut').val(),
              password: $('#Pass').val(),
